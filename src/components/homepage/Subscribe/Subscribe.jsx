...
const Subscribe = () => {
    return (
        <div className='w-10/12 mx-auto bg-linear-to-r from-[#caf0f8] to-[#ffe5ec] border-2 border-[#00000030] rounded-xl py-16 px-2 text-center my-5'>
            ...
            <div>
                <input
                    className='max-w-[150px] sm:max-w-[350px] border-2 border-[#00000030] rounded-xl p-2 mr-3 font-semibold'
